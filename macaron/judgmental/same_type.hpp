...
#define MACARON_JUDGMENTAL_SAME_TYPE(...) \
    ...
    ((MACARON_RUDIMENTAL_WHITESPACE_SEPARATED_PAIR(Not the same as, MACARON_JUDGMENTAL_SAME_TYPE_SUPPOSED_TYPE)), std::same_as<__VA_ARGS__, MACARON_JUDGMENTAL_SAME_TYPE_SUPPOSED_TYPE>)
