...
#define MACARON_JUDGMENTAL_EQUAL_VALUE(...) \
    ...
    ((MACARON_RUDIMENTAL_WHITESPACE_SEPARATED_PAIR(Not equal to, MACARON_JUDGMENTAL_EQUAL_VALUE_SUPPOSED_VALUE)), __VA_ARGS__ == MACARON_JUDGMENTAL_EQUAL_VALUE_SUPPOSED_VALUE)
