...
#define MACARON_JUDGMENTAL_DERIVED_TYPE(...)   \
    ...
    ((MACARON_RUDIMENTAL_WHITESPACE_SEPARATED_PAIR(Not derived from, MACARON_JUDGMENTAL_DERIVED_TYPE_SUPPOSED_BASE)), std::derived_from<__VA_ARGS__, MACARON_JUDGMENTAL_DERIVED_TYPE_SUPPOSED_BASE>)
